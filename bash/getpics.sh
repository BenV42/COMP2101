...
wget -q -O ~/public_html/pics/pics.zip http://zonzorp.net/pics.zip https://zonzorp.net/pics.tgz && unzip -d ~/public_html/pics -o -q ~/public_html/pics/pics.zip && tar -x -f ~/public_html/pics/pics.tgz && rm ~/public_html/pic/pics.zip
# Task 1: Improve this script to also retrieve and install the files kept in the https://zonzorp.net/pics.tgz tarfile
